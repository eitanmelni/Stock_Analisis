...
'''
BACKLOG
- EL DISPONIBLE PARA OPERAR EN EL ULTIMO PORTFOLIO Y SU GRAFICO TOMA EL COMPROMETIDO COMO PARTE DEL DISPONIBLE (ERROR)
- EN EL GRAFICO DE TENENCIAS, EL TOTAL DE LA CARTERA HAY QUE REDONDEARLO (A 0 O A 2 DIGITOS COMO MUCHO)
- EN LA FUNCION BAJAR PORTFOLIO HAY QUE AGREGAR UNA COLUMNA QUE SEA EL RENDIMIENTO Y OTRA PARA EL REND. MENSUALIZADO 
'''
